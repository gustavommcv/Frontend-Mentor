 /**
     * Creates a card component and appends it to the body.
     * @param {string} title - The card title.
     * @param {string} color - The background color of the card.
     * @param {string} svg - The SVG icon as a string.
     * @param {string} description - The description text.
     */
 function createCardComponent(title, color, svg, description, position) {
    ...
    svgContainer.querySelector('svg').classList.add('card__icon');
    ...
    const main = document.querySelector(`.main__container-${position}`);
